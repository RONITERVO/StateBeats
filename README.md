...
**0.2.0 release candidate.** Headless and desktop checks are recorded in
...
hands at the reticle. Q/E turn, C ducks beneath birds, Escape pauses. Mouse bindings, speed and
...
traveling-sun map at the chosen density. Music features and note paths are saved in exported
...
| `@statebeats/content` | Six original sequences, including sun/space scenes and seeded generation examples |
...
`artifacts/release/0.2.0/`, then installs all public tarballs together in a fresh directory and runs the CLI
